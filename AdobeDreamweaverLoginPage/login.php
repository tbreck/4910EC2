...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<form method= "post">
		...
		<button type="submit" id="LoginPageRegisterButtonDriver" formaction="/AdobeDreamweaverRegistrationPage/RegisterDriverPage.html">Register [Driver]<button><center></br>
		<button type="submit" id="LoginPageRegisterButtonSponsor" formaction="/AdobeDreamweaverRegistrationPage/RegisterSponsorPage.html">Register [Sponsor]<button></center>
	</form>
	</div>
